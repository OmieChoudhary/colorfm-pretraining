...
Validate that the FoundationPretrainauxiliary target pretraining loop runs end-to-end on CPU using the small synthetic spectral dataset.
...
3. train a reconstruction + auxiliary target prediction objective
4. save a checkpoint
5. run reconstruction evaluation
6. run downstream metric evaluation
...
- Objective: masked spectral reconstruction + auxiliary target prediction
